	...
	<div class="main">
		...
		<div class="divLayer">
			...
			<div>
				...
				<label>发布日期：</label><input type="text" class="art_in form_datetime" value="<{$pubdate}>" readonly name="pubdate" id="pubdate" size="30" placeholder="请选择文章发表日期">
			</div>
			<div>
			...
			<div>
				<label>文章作者：</label><input type="text" value="<{$editor}>" name="editor" id="editor" class="art_in" size="20">
