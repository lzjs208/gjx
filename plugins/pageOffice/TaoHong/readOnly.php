<?php
	...
	$fileName = "zhengshi.doc"; // 正文内容文件：test.doc
	$PageOfficeCtrl->setCaption($fileName);			
	$PageOfficeCtrl->addCustomToolButton("另存到本地", "ShowDialog1()", 5);
    $PageOfficeCtrl->addCustomToolButton("页面设置", "ShowDialog2()", 0);
    $PageOfficeCtrl->addCustomToolButton("打印", "ShowDialog3()", 6);
